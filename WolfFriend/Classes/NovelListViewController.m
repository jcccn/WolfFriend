...
@interface NovelListViewController ()
...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(dataCenterUpdated:) name:@"DataCenterBookSubCategoryUpdated" object:nil];
    [self refresh:nil];
}
...
- (void)loadDataAtPage:(NSInteger)page {
    ...
    [[CategoryDataCenter sharedInstance] parseBookCategory:self.categoryModel atPage:page];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NovelBrowserViewController *novelBrowserViewController = [[NovelBrowserViewController alloc] initWithArticle:article];
