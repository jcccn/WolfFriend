...
- (void)loadAllImageCategories {
    ...
    [NSURLConnection bk_startConnectionWithRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[baseUrl stringByAppendingPathComponent:@"/index.php"]]]
                                 successHandler:^(NSURLConnection *urlConnection, NSURLResponse *urlResponse, NSData *data) {
                                     ...
                                     TFHpple *doc = [TFHpple hppleWithData:data isXML:NO];
...
- (void)parseImageCategory:(SubCategoryModel *)category atPage:(NSInteger)pageIndex {
    ...
    __weak CategoryDataCenter *blockSelf = self;
    [NSURLConnection bk_startConnectionWithRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:categoryUrl]]
                                 successHandler:^(NSURLConnection *urlConnection, NSURLResponse *urlResponse, NSData *data) {
                                     TFHpple *doc = [TFHpple hppleWithData:data isXML:NO];
