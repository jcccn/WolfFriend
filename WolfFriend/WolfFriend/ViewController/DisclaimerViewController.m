...
- (void)viewDidLoad
{
    ...
    if ( ! disclaimerLabel) {
        disclaimerLabel = [[UILabel alloc] initWithFrame:self.view.bounds];
        disclaimerLabel.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
